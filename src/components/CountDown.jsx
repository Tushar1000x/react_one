		...
		<div className={styles.widget}>
          ...
          />
			...
			<div className={styles.right}>
				...
				{isActive ? (
					<>
						<button onClick={handleStartStop} className={styles.stopreset}>Stop</button>
						<button onClick={handleStartStoped} className={styles.stopreset}>Reset</button>
					</>
				) : (
					<button onClick={handleStartStop} className={styles.stopreset}>Start</button>
				)}
			</div>
		</div>
	);
